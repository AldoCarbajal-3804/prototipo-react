    ...
    return(
        <section className="cta-section p-4 sm:p-6 md:p-8 lg:p-8 bg-blue-200">
            <blockquote className="cta rounded-xl sm:rounded-2xl p-8 sm:p-12 shadow-lg bg-sky-100">
                ...
                <p className="text-center text-sm sm:text-base md:text-lg pb-6 sm:pb-8 px-4">Transforma tu negocio con automatización impulsada por IA hoy. Construyamos algo extraordinario juntos.</p>
