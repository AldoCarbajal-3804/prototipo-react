...
function IconHero(){
    return (
        <>
            ...
            <div className="w-32 sm:w-40 lg:w-56 h-32 sm:h-40 lg:h-56 border border-[#3AA1B8] rounded-full flex justify-center items-center breathing-md">
                <div className="w-24 sm:w-32 lg:w-40 h-24 sm:h-32 lg:h-40 border border-[#3AA1B8] rounded-full flex justify-center items-center breathing-sm">
