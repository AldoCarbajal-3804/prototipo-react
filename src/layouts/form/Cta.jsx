...
function CtaSection(){
    ...
    return(
        <section className="cta-section p-4 sm:p-6 md:p-8 lg:p-8 bg-blue-200 border-b-2 border-gray-500">
            <div className="cta rounded-xl sm:rounded-2xl p-8 sm:p-12 shadow-lg bg-sky-100">
