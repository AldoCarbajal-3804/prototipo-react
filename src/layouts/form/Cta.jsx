    ...
    return(
        <section ref={sectionRef} className="cta-section relative overflow-hidden p-4 sm:p-6 md:p-8 lg:p-8 bg-blue-200 border-b-2 border-neutral-500">
            ...
            >
                ...
                <div className="text-center"><button className="bg-blue-950 px-4 sm:px-5 md:px-6 py-3 sm:py-4 rounded-lg md:rounded-xl font-bold text-sm sm:text-base md:text-lg cursor-pointer hover:opacity-90 transition text-neutral-100"> <a href="#form-section">{t.cta.button}</a></button></div>
            </div>
        </section>
    )
}
