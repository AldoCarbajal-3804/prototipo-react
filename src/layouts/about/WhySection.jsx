...
function WhySection() {
    ...
    return(
        <article id="why-section" className="bg-blue-100 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 border-b-2 border-gray-500 relative overflow-hidden">
            ...
            <section className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-10">
                <header className="lg:w-1/3 text-left">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-[1.1] text-gray-900">
