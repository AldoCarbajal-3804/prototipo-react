export const Card = ({ icon, name, description }) => {
    return(
        <blockquote className="card rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg" role="region" aria-labelledby={`card - ${name}`}>
            <div className="icon-wrapper w-10 sm:w-12 h-10 sm:h-12 rounded-lg flex items-center justify-center mb-3 cursor-pointer" role="img" aria-label={`Icono de ${name}`}>
